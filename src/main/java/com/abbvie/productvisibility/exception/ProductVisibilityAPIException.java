 ...
 *
 */
public class ProductVisibilityAPIException extends Exception {
	 ...
	 * @param link
	 */
	public ProductVisibilityAPIException(int status, int code, String message,
	...
	public ProductVisibilityAPIException() { }
